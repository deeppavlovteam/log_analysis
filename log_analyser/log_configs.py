...
RAW_FILES_LOG_CONFIG = {
    'log_dir': '/home/ignatov/log_stuff/new/src',
    'pickle_file': '/home/ignatov/log_stuff/new/new.pkl',
    'hashes_file': '/home/ignatov/log_stuff/new/raw_hashes.txt',
    'reports_dir': 'reports',
    'log_file_name_glob_pattern': '*access.log*',
    'log_arc_file_name_re_pattern': r'.+\.gz$',
    'log_source_pattern': r'^(\S+?)\s(\S+?)\s(\S+?)\s(\[.+?\])\s(".+?")\s(.+?)\s(.+?)\s(".+?")\s(".+?")\s(".+?")$',
...
PROCESSED_FILES_LOG_CONFIG = {
    'log_dir': '',
    'pickle_file': '/home/ignatov/log_stuff/new/processed.pkl',
    'hashes_file': '',
    'reports_dir': 'reports',
    'log_file_name_glob_pattern': '*access.log*',
